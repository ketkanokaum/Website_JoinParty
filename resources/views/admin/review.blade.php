...
<body>
  <div class="wapper">
    ...
    <div class="coll">
      <div class="card">
        <h5 class="card-title">ชื่อกิจกรรม : <span>{{ $partyReviews->first()->party->party_name }}</span></h5>
        <small class="text-muted">ค่าเฉลี่ยคะแนน: {{ number_format($avg_ratings[$partyId]->average_rating, 2) }}/5.00</small>
            ...
            <div class="modal-body">
              ...
              <div class="card mb-3">
                <div class="card-body">
                  ...
                  <h5 class="card-title">{{ $review->attendance->user->username }}</h5>
                  <p class="card-subtitle text-muted">{{ $review->attendance->user->email }}</p>
                  <strong>วันที่รีวิว :</strong> {{ thaidate($review->attendance->created_at) }}
